...
// chips hobbit pc game patches added. 
...
void PerformHexEdits1() {
    float floatNewValue = 16.0f;
   
    // Define the offset to write the new float value
    DWORD offset = 0x006EFBD8;
...
const std::vector<BYTE> commonHexEdit = { 0x7C, 0xD9, 0xA0, 0x3F, 0xC7, 0x80, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x46 }; // 1.25663709640503
...
HexEdit CreateHexEditFromFOV(int FOVIndex) {
    HexEdit edit;

    switch (FOVIndex) {
    case 1:
        edit.modified = { 0x00, 0x00, 0xC0, 0x3F, 0xC7, 0x80, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x46 };  // 1.5
        edit.offset = 0;
        break;
    case 2:
        edit.modified = { 0x66, 0x66, 0xE6, 0x3F, 0xC7, 0x80, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x46 };  // 1.8 
        edit.offset = 0;
        break;
    case 3:
        edit.modified = { 0x00, 0x00, 0x00, 0x40, 0xC7, 0x80, 0xE4, 0x00, 0x00, 0x00, 0x00, 0x40, 0x9C, 0x46 };  // 2
        edit.offset = 0;
        break;
    default:
...
void PerformHexEdits() {
    ...
    HexEdit edit = CreateHexEditFromFOV(FOVIndex);
